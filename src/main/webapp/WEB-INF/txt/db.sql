...
insert into customer_voucher values('6', '1', '2');
insert into customer_voucher values('7', '1', '4');
insert into customer_voucher values('8', '1', '6');
insert into customer_voucher values('9', '1', '8');
insert into customer_voucher values('10', '1', '10');
